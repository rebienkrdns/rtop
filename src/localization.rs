...
pub fn translate(key: &'static str, lang: Language) -> &'static str {
    match lang {
        Language::English => match key {
            ...
            "Change theme" => "Cycle visual themes",
            "Theme" => "Theme",
            ...
            "EnvToggleShow" => "Show env values",
            "EnvToggleHide" => "Hide env values",
        ...
        Language::Spanish => match key {
            ...
            "Disk W" => "Disco W",
            "Disk" => "Disco",
            "Disk I/O use" => "Uso de E/S de disco",
            "Uptime" => "Uptime",
            "User" => "Usuario",
            "Threads" => "Threads",
            "Path" => "Ruta (Exe)",
            ...
            "Change theme" => "Cambiar tema visual",
            "Theme" => "Tema",
            ...
            "Mem Disk Net" => "Memoria · Disco · Red",
            ...
            "EnvToggleShow" => "Mostrar env vars",
            "EnvToggleHide" => "Ocultar env vars",
